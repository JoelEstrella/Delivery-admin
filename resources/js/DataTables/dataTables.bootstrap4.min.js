...
(function (b) { "function" === typeof define && define.amd ? define(["jquery", "datatables.net"], function (a) { return b(a, window, document) }) : "object" === typeof exports ? module.exports = function (a, d) { a || (a = window); if (!d || !d.fn.dataTable) d = require("datatables.net")(a, d).$; return b(d, a, a.document) } : b(jQuery, window, document) })(function (b, a, d, m) {
    var f = b.fn.dataTable; b.extend(!0, f.defaults, {
        ...
        renderer: "bootstrap"
    }); b.extend(f.ext.classes, { sWrapper: "dataTables_wrapper dt-bootstrap4", sFilterInput: "form-control", sLengthSelect: "form-control", sProcessing: "dataTables_processing card", sPageButton: "page-item" }); f.ext.renderer.pageButton.bootstrap = function (a, h, r, s, j, n) {
                ...
                if (c = f[l], b.isArray(c)) q(d, c);
                    ...
                    switch (c) {
                        ...
                        case "first": e = k.sFirst; g = c + (0 < j ? "" : " disabled");
                            break;
                        case "previous": e = '<i data-feather="chevron-left"></i>'/*k.sPrevious*/; g = c + (0 < j ? "" : " disabled");
                            break;
                        case "next": e = '<i data-feather="chevron-right"></i>'/*k.sNext*/; g = c + (j < n - 1 ? "" : " disabled");
                            break;
