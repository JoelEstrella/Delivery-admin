...
@section('content')
    <div class="mb-4">
        ...
        <div class="page-subtitle">Resumen general de la operación del sistema</div>
    </div>
            ...
            <div class="card-admin p-4 h-100">
                <div class="d-flex align-items-center justify-content-between mb-3">
                    <div>
                        ...
                        <div class="text-muted small">Últimos movimientos y acciones registradas</div>
                    </div>
                    <a href="{{ route('admin.logs.index') }}" class="btn btn-sm btn-outline-secondary">Ver bitácora</a>
                </div>
                ...
                <div class="table-responsive">
                    <table class="table table-hover align-middle table-admin mb-0">
                        ...
                        <tbody>
                            ...
                            @empty
                                <tr>
                                    <td colspan="5" class="text-center text-muted py-4">Aún no hay actividad registrada.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
        ...
        <div class="col-12 col-xl-4">
            <div class="card-admin p-4 h-100">
                ...
                <div class="d-grid gap-2">
                    <a href="{{ route('admin.users.index') }}" class="btn btn-outline-primary text-start">Usuarios</a>
                    <a href="{{ route('admin.roles.index') }}" class="btn btn-outline-primary text-start">Roles</a>
                    <a href="{{ route('admin.ccts.index') }}" class="btn btn-outline-primary text-start">CCT</a>
                    <a href="{{ route('admin.plants.index') }}" class="btn btn-outline-primary text-start">Plantas</a>
                    <a href="{{ route('admin.deliveries.index') }}" class="btn btn-outline-primary text-start">Entregas</a>
                    <a href="{{ route('admin.delivery-validations.index') }}" class="btn btn-outline-primary text-start">Validaciones</a>
                </div>
            </div>
        </div>
    </div>
